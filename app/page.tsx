      ...
      <nav className="fixed top-0 left-0 right-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md z-50 border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <img src="/logo.png" alt="voru" className="h-[150px] w-auto" />
          ...
          <div className="relative">
            <div className="bg-gray-100 dark:bg-gray-800 rounded-3xl p-8 relative">
              <div className="absolute top-4 right-4 bg-white dark:bg-gray-700 rounded-xl p-4 shadow-lg">
                <p className="text-sm text-gray-500 dark:text-gray-400">{ t.hero.expressDelivery}</p>
                <p className="text-2xl font-bold dark:text-white">{ t.hero.expressTime}</p>
              </div>
              <div className="mx-auto mt-8 mb-8 rounded-xl overflow-hidden"><LocationMap /></div>
              <h3 className="text-xl font-bold text-center mb-2 dark:text-white">{ t.hero.realtimeTracking}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-center">{ t.hero.trackingDesc}</p>
            </div>
          </div>
        </div>
      </section>
